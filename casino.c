...
long long setBet(long long bank, long long *pot)
{
    system("cls");
    long long bet;
    printf("You currently have $%lld in your bank. There are $%lld in the pot. How much money would you like to bet (Enter 0 to cancel your bet): ", bank, *pot);
    scanf("%lld", &bet);
    ...
    while(bet > bank)
    {
        printf("You currently have $%lld in your bank. There are $%lld in the pot. How much money would you like to bet (Enter 0 or below to cancel your bet): ", bank, *pot);
        scanf("%lld", &bet);
    }
    ...
    *pot += bet * 2; //Doubles bet to account for dealer adding to the pot as well
    ...
    printf("Player bets $%lld. There are now $%lld in the pot...", bet, *pot);
    sleep(1);
...
int gameStart(int bank)
{
    long long pot = 0;
    bank = setBet(bank, &pot);
    printf("%lld %lld", bank, pot);
...
int playBlackJack(int bank)
{
    ...
    while(option != 0)
    {
        ...
        switch(option)
        {
            ...
            case 3:
                system("cls");
                printf("You currently have $%d in your bank.", bank);
                break;
            default:
